...
From within Semaphore, you can configure your GitHub repository as a "Project" and run the provisioning playbooks using the automatically uploaded `vars/hosts` inventory.
